    ...
    const handleSubmitQuestion = async () => {
        ...
        try {
            ...
            if (response.ok) {
                toast({
                    title: "Success",
                    description: "Your question has been posted! AI is generating an answer...",
                })
                setQuestionTitle("")
                setQuestionContent("")
                setDialogOpen(false)
                // Refresh posts after a short delay to allow AI reply to generate
                setTimeout(() => {
                    fetchPosts()
                }, 2000)
            } else {
            ...
            <div className="flex items-center justify-between">
                <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                        Ask questions, share knowledge, and get help from peers and AI
                    </p>
                </div>
                <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                    ...
                    <DialogContent className="sm:max-w-[600px]">
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Post your question to the forum. Our AI assistant will try to help!
                            </DialogDescription>
                        </DialogHeader>
            ...
            {loading ? (
                ...
                <div className="space-y-4">
                    {filteredPosts.map((post) => (
                        <Link key={post.id} href={`/student/forum/${post.id}`} className="block">
